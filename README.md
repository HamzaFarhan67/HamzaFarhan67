...
<p align="left">
  <a href="https://github.com/HamzaFarhan67">
    <img src="https://github-readme-stats-eight.vercel.app/api?username=HamzaFarhan67&show_icons=true&theme=tokyonight&count_private=true&hide_border=true" height="165" alt="GitHub Stats" />
  </a>
  <a href="https://github.com/HamzaFarhan67">
    <img src="https://github-readme-stats-eight.vercel.app/api/top-langs/?username=HamzaFarhan67&layout=compact&theme=tokyonight&hide_border=true&langs_count=8" height="165" alt="Top Languages" />
  </a>
</p>
...
![Assembly](https://img.shields.io/badge/x86_Assembly-000000?style=for-the-badge&logo=ghost&logoColor=white)
...
![SFML](https://img.shields.io/badge/SFML-8CC63F?style=for-the-badge&logo=sfml&logoColor=black)
...
#### 1. 🤖 [FinanceAnalysis — Multi-Agent Financial AI](https://github.com/HamzaFarhan67/FinanceAnalysis)
- **Description:** A multi-agent AI system that ingests transaction data, tracks budgets, produces conversational financial summaries, and automatically renders visualizations.
- **Tech Stack:** `Python 3.11` `FastAPI` `FastMCP` `Pydantic AI` `SQLAlchemy` `PostgreSQL` `pgvector` `React`
- **Key Features:**
  - Automated agent orchestration (transaction, budget, forecast, summarizer, and visualization subagents).
  - RAG utilities for chunking, vector embeddings, and retrieval using PostgreSQL + pgvector.
  - Automatic DataFrame summarization and chart rendering pipeline (ChartSpec → matplotlib PNG).

#### 2. 🍲 [PantryToPlate — Agentic AI Culinary Platform](https://github.com/HamzaFarhan67/PantryToPlate)
- **Description:** An AI-powered cooking assistant that tracks pantry ingredients and features a conversational "Chef Coach" chatbot for real-time, step-by-step guidance.
- **Tech Stack:** `React` `Tailwind CSS` `Firebase` `FastAPI` `LangChain` `Google Gemini` `Pydantic`
- **Key Features:**
  - Real-time pantry tracking with Firebase authentication and cloud synchronization via Firestore.
